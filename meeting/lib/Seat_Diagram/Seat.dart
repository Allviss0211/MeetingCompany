          ...
          Flexible(
            child: ClipRect(
              child: PhotoView.customChild(
                minScale: 0.25,
                maxScale: 10.0,
                customSize: Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height - 221),
                childSize: Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height - 221),
